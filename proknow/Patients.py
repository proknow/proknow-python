...
class EntityScorecards(object):
    ...
    def create(self, name, computed, custom):
        ...
        Returns:
            :class:`proknow.Patients.EntityScorecardItem`: A representation of the created custom
            metric.
        ...
        _, scorecard = self._requestor.post('/workspaces/' + self._workspace_id + '/entities/' + self._entity_id + '/metrics/sets', body={'name': name, 'computed': computed, 'custom': custom})
...
class EntityScorecardItem(object):
    ...
    This class represents a entity scorecard. It's instantiated by the
    :class:`proknow.Patients.EntityScorecardItem` class as a complete representation of the
    scorecard.
